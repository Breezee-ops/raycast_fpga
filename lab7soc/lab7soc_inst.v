	lab7soc u0 (
		...
		.player_cond_player_x            (<connected-to-player_cond_player_x>),            //              player_cond.player_x
		.player_cond_player_y            (<connected-to-player_cond_player_y>),            //                         .player_y
		.player_cond_player_a            (<connected-to-player_cond_player_a>),            //                         .player_a
		.player_x_pio_export             (<connected-to-player_x_pio_export>),             //             player_x_pio.export
		...
		.player_y_pio_export             (<connected-to-player_y_pio_export>),             //             player_y_pio.export
		.player_a_pio_export             (<connected-to-player_a_pio_export>)              //             player_a_pio.export
	);
